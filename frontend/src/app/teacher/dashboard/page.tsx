  ...
  return (
    <div className="flex min-h-screen bg-[#f8f9fc]">
      ...
      <div className="flex-1 flex flex-col min-h-screen relative">
        ...
        <main className={`flex-1 p-4 sm:p-6 lg:p-10 overflow-auto bg-[#f8f9fc] 
            ...
            <div className="flex flex-col sm:flex-row sm:items-center 
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs sm:text-sm font-semibold text-gray-400 
                              tracking-wide uppercase italic">
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 bg-blue-600 
                           hover:bg-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 
                           rounded-xl sm:rounded-2xl font-bold shadow-xl 
                           shadow-blue-200 transition-all hover:-translate-y-0.5 
                           active:scale-95 group w-full sm:w-auto"
              >
          ...
          <footer className="mt-20 pt-10 border-t border-gray-100/50 
                             flex items-center justify-between opacity-50 
                             transition-opacity hover:opacity-100">
            <p className="text-xs font-bold text-gray-400 uppercase 
                          tracking-widest leading-none">
              SmartAssess © 2026 // All rights reserved
            </p>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-blue-600" />
              <p className="text-xs font-bold text-blue-600 uppercase 
                            tracking-widest leading-none underline 
                            decoration-blue-200 underline-offset-4">
                Privacy Policy
              </p>
            </div>
          </footer>
